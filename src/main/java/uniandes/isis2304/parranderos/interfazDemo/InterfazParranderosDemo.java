...
//			e.printStackTrace ();
    ...
    public void demoTipoBebida( )
    {
    	try 
    	{
			...
			VOPARQUEDAERO tipoBebida = parranderos.adicionarTipoBebida (nombreTipoBebida);
			if (tipoBebida == null)
			{
...
//			e.printStackTrace();
	...
	public void demoBebida( )
    {
    	try 
    	{
			...
			VOLECTOR bebida = parranderos.adicionarBebida(nombreBebida, tipoBebida.getId (), 10);
			
			List <VOPARQUEDAERO> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOLECTOR> listaBebidas = parranderos.darVOBebidas();
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas1 ( )
    {
    	try 
    	{
			...
			VOLECTOR bebida1 = parranderos.adicionarBebida("120", tipoBebida.getId (), 10);
			VOLECTOR bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOLECTOR bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			
			List <VOPARQUEDAERO> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOLECTOR> listaBebidas1 = parranderos.darVOBebidas();
			List <VOSirven> listaSirven = parranderos.darVOSirven ();
			long noServidasEliminadas = parranderos.eliminarBebidasNoServidas();
			List <VOLECTOR> listaBebidas2 = parranderos.darVOBebidas();
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			VOLECTOR bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOLECTOR bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			VOCENTRO_COMERCIAL bar1 = parranderos.adicionarBar ("Los Amigos", "Bogotá", "Bajo", 2);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			
			List <VOPARQUEDAERO> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOLECTOR> listaBebidas1 = parranderos.darVOBebidas();
			List <VOCENTRO_COMERCIAL> bares = parranderos.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOCENTRO_COMERCIAL> lista = parranderos.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			boolean errorTipoBebida = false;
			VOPARQUEDAERO tipoBebida = parranderos.adicionarTipoBebida ("Vino tinto");
			if (tipoBebida == null)
			{
			...
			VOLECTOR bebida1 = parranderos.adicionarBebida ("120", tipoBebida.getId (), 10);
			VOLECTOR bebida2 = parranderos.adicionarBebida ("121", tipoBebida.getId (), 10);
			VOLECTOR bebida3 = parranderos.adicionarBebida ("122", tipoBebida.getId (), 10);
			VOLECTOR bebida4 = parranderos.adicionarBebida ("123", tipoBebida.getId (), 10);
			VOLECTOR bebida5 = parranderos.adicionarBebida ("124", tipoBebida.getId (), 10);
			VOCENTRO_COMERCIAL bar1 = parranderos.adicionarBar ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOCENTRO_COMERCIAL bar2 = parranderos.adicionarBar ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOCENTRO_COMERCIAL bar3 = parranderos.adicionarBar ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOCENTRO_COMERCIAL bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			...
			List <VOPARQUEDAERO> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOLECTOR> listaBebidas = parranderos.darVOBebidas ();
			List <VOCENTRO_COMERCIAL> listaBares = parranderos.darVOBares ();
			List <VOSirven> listaSirven = parranderos.darVOSirven ();
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			List <VOCENTRO_COMERCIAL> listaBares2 = parranderos.darVOBares ();
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOESPACIO bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOESPACIO bdor2 = parranderos.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOESPACIO bdor3 = parranderos.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOESPACIO> bebedores = parranderos.darVOBebedores();
			VOESPACIO bdor5 = parranderos.darBebedorPorId(bdor1.getId ());
			VOESPACIO bdor6 = parranderos.darBebedorPorId(0);
			List <VOESPACIO> pepitos = parranderos.darVOBebedoresPorNombre("Pepito");
			List <VOESPACIO> pedritos = parranderos.darVOBebedoresPorNombre("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			List <VOPARQUEDAERO> listaTipos = parranderos.darVOTiposBebida();
			List <VOLECTOR> listaBebidas = parranderos.darVOBebidas();
			List <VOCENTRO_COMERCIAL> listaBares = parranderos.darVOBares ();
			List <VOESPACIO> bebedores = parranderos.darVOBebedores();
			List <VOLOCAL_COMERCIAL> listaGustan = parranderos.darVOGustan();
			List <VOVISITA> listaVisitan = parranderos.darVOVisitan();

			VOESPACIO bdor2 = parranderos.darBebedorCompleto(bdor1.getId ());
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOESPACIO> bebedores1 = parranderos.darVOBebedores ();
			long bebedoresActualizados = parranderos.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOESPACIO> bebedores2 = parranderos.darVOBebedores ();
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOCENTRO_COMERCIAL bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOESPACIO bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOESPACIO bdor2 = parranderos.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOESPACIO bdor3 = parranderos.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOESPACIO bdor4 = parranderos.adicionarBebedor ("Luis", "Cartagena", "Medio");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			...
			List<VOCENTRO_COMERCIAL> bares = parranderos.darVOBares();
			List<VOESPACIO> bebedores = parranderos.darVOBebedores();
			List<VOVISITA> visitan = parranderos.darVOVisitan ();
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOCENTRO_COMERCIAL bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOESPACIO bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOESPACIO bdor2 = parranderos.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOESPACIO bdor3 = parranderos.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
...
//			e.printStackTrace();
    ...
    public void demoGustan ( )
    {
		try 
		{
			...
			List <VOPARQUEDAERO> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOLECTOR> listaBebidas = parranderos.darVOBebidas ();
			List <VOESPACIO> listaBebedores = parranderos.darVOBebedores ();
			List <VOLOCAL_COMERCIAL> listaGustan = parranderos.darVOGustan();
			long gustanEliminados = parranderos.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = parranderos.eliminarBebidaPorNombre ("120");
			long tbEliminados = parranderos.eliminarTipoBebidaPorNombre ("Vino tinto");
...
//			e.printStackTrace();
     ...
     */
    private String listarBebidas (List<VOLECTOR> lista) 
    {
    	String resp = "Las bebidas existentes son:\n";
    	int i = 1;
        for (VOLECTOR beb : lista)
        {
        	resp += i++ + ". " + beb.toString() + "\n";
        }
        return resp;
     ...
     */
    private String listarBebedores (List<VOESPACIO> lista) 
    {
    	String resp = "Los bebedores existentes son:\n";
    	int i = 1;
        for (VOESPACIO bdor : lista)
        {
     ...
     */
    private String listarBares (List<VOCENTRO_COMERCIAL> lista) 
    {
    	String resp = "Los bares existentes son:\n";
    	int i = 1;
        for (VOCENTRO_COMERCIAL bar : lista)
        {
        	resp += i++ + ". " + bar.toString() + "\n";
        }
        return resp;
     ...
     */
    private String listarGustan (List<VOLOCAL_COMERCIAL> lista) 
    {
    	String resp = "Los gustan existentes son:\n";
    	int i = 1;
        for (VOLOCAL_COMERCIAL serv : lista)
        {
     ...
     */
    private String listarVisitan (List<VOVISITA> lista) 
    {
    ...
    private String listarBebedorYNumVisitas (List<Object[]> lista) 
    {
        ...
        {
			VOESPACIO bdor = (VOESPACIO) tupla [0];
